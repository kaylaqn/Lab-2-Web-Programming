...
function start() {
    ...
    bear = new Bear();
    //speed of the bear 
    document.getElementById("speedBears").onchange = function() {setSpeed()};
    ...
    onkeydown = lastStingTime = new Date();
...
function Bear(){
    ...
    function setSpeed() {
        let bearsspeed = document.getElementById("speedBears").value;
        return bearsspeed;
      }
...
function createBeeImg(wNum) {
    ...
    img.setAttribute("src", "images/bees.gif");
